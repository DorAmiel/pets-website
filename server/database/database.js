const database = {
    ...
    dogs: [
        ...
        { id: 3, name: 'Mica', age: 8, breed: 'German', ownerId: 3 },
        { id: 4, name: 'Kao', age: 3, breed: 'Haski', ownerId: 4 },
        { id: 5, name: 'Mica', age: 9, breed: 'Pitbull', ownerId: null },
        { id: 6, name: 'Mica', age: 9, breed: 'Pitbull', ownerId: 1 },
        { id: 7, name: 'Mica', age: 9, breed: 'Pitbull', ownerId: 1 }
    ]
}
